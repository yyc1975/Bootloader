 ...
 * @ingroup UCL_RSA_SSA_PKCS1V15_SHA1
 */
int ucl_pkcs1_ssa_pkcs1v15_sha1_crt_sign(u8 *signature, u8 *message, u32 message_length, ucl_rsa_crt_private_key_t *keyPr);
 ...
 * @ingroup UCL_RSA_SSA_PKCS1V15_SHA1
 */
  int ucl_pkcs1_emsa_pkcs1v15_sha1_encode(u8 *EM, u8 *M, u32 M_length, u32 k);
 ...
 * @ingroup UCL_RSA_SSA_PKCS1V15_SHA1
 */
  int ucl_pkcs1_emsa_pkcs1v15_sha1_verify(u8 *EM, u8 *M, u32 M_length, u32 k);
