 ...
 *
 * @param[in,out] length    Valid pointer to the size of response buffer, 
					...
					unsigned int *r_length)
{
    ...
    *dev->rx_size = 0;
    ...
    /* Register services */
    mml_sc_dev_register_service( mml_sc_vsr_t0_in);
    /* Prepare the send of the header {CLA INS P1 P2 Lc} */
    mml_sc_dev_send_data( 5);
    /* Ready to receive procedure byte */
