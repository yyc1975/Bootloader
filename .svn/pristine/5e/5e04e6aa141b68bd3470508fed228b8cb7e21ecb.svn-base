...
int ucl_ecies_encrypt_p256r1_aes_hmac_sha256(u8 *rx,u8 *ry, u8 *crypto, u8 *t,u32 keylength,u8 * xG,u8 *yG,u8 *xQ,u8 * yQ,u8 *a,u8 *n,u8 *p, u8 *m,u32 MsgLng);
...
int ucl_ecies_decrypt_p256r1_aes_hmac_sha256(u8 *m,u32 keylength,u8 * xG,u8 *yG,u8 *a,u8 *n,u8 *p, u8 *d,u8 *rx,u8 *ry, u8 *crypto,int crypto_len,u8 *t);
 ...
 *
 * @ingroup UCL_ECC_ECIES */
int ucl_ecies_encrypt_aes_hmac_sha256(ucl_type_ecc_u8_affine_point Q, u8 *crypto, u8 *t,ucl_type_ecc_u8_affine_point pubkey,u8 *input,u32 inputlength,ucl_type_curve *curve_params);
 ...
 *
 * @ingroup UCL_ECC_ECIES */
int ucl_ecies_decrypt_aes_hmac_sha256(u8 *message,u8 *d,ucl_type_ecc_u8_affine_point pubkey,u8 *crypto,int cryptolength,u8 *t,ucl_type_curve *curve_params);
